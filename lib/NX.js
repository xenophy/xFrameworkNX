...
require('./NX/core/string/sprintf.js');
...
require('./NX/util/Path.js');
require('./NX/util/Format.js');
require('./NX/util/JSON.js');
require('./NX/util/MarkDown.js');
require('./NX/ServiceMgr.js');
require('./NX/Url.js');
require('./NX/http/Server.js');
require('./NX/http/Dispatcher.js');
require('./NX/http/View.js');
require('./NX/http/Controller.js');
