...
var Observable = module.exports = NX.extend(Object, {
...
NX.override(Observable, {
     ...
     * @param {Object} o オプションオブジェクト
     */
    on: Observable.prototype.addListener,
     ...
     * @param {Object}   scope     (オプション)スコープ
     */
    un: Observable.prototype.removeListener
...
Observable.observe = function(cls, listeners) {
